...
public class AutoWARPBlocksBlueBridge extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        color_right = hardwareMap.get(ColorSensor.class, "color_right");
    ...
    private boolean isYellow() {
        float[] hsv = {0F, 0F, 0F};
        Color.RGBToHSV(color_right.red() * 255, color_right.green() * 255, color_right.blue() * 255, hsv);
